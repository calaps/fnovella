...
public class InscriptionsInstGrade {
	...
	public void setUpdateFields(InscriptionsInstGrade inscriptionsInstGrade) {
		...
		if (inscriptionsInstGrade.instructorId > 0) this.instructorId = inscriptionsInstGrade.instructorId;
		if (inscriptionsInstGrade.period > 0) this.period = inscriptionsInstGrade.period;
		if (inscriptionsInstGrade.year > 0) this.year = inscriptionsInstGrade.year;
		if (inscriptionsInstGrade.gradeId > 0) this.gradeId = inscriptionsInstGrade.gradeId;
	}
}