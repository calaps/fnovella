...
public class ProgramController {
    ...
    @RequestMapping(value = "insights/program/{program}", method = RequestMethod.GET)
    public APIResponse getInsightsByProgram(@RequestHeader("authorization") String authorization, @PathVariable("program") Integer programId) {
        return new APIResponse(this.programService.getInsightsByProgram(programId), null);
    }

    @RequestMapping(value = "insights", method = RequestMethod.GET)
    public APIResponse getInsightsForAllPrograms(@RequestHeader("authorization") String authorization) {
        return new APIResponse(this.programService.getInsightsForAllPrograms(), null); 
    }
    ...
    public APIResponse getCategories(@PathVariable("id") Integer id,
    ...
    public APIResponse getLocations(@PathVariable("id") Integer id,
            @RequestHeader("authorization") String authorization) {
        return new APIResponse(this.programLocationRepository.findByProgram(id), null);
    }

    @RequestMapping(value = "", method = RequestMethod.POST)
    public APIResponse create(@RequestBody ProgramLocationCategory program,
            @RequestHeader("authorization") String authorization) {
    ...
    public APIResponse update(@RequestBody ProgramLocationCategory program,
            @RequestHeader("authorization") String authorization, @PathVariable("id") Integer id) {
    ...
    private void createProgramLocationAndAditionalFieldsRelation(@RequestBody ProgramLocationCategory program,
            ProgramLocationCategory saved) {
    ...
    public APIResponse checkDeletion(@RequestHeader("authorization") String authorization,
