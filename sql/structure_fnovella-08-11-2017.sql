...
(
	...
	evaluation_performmance bit,
	months_total int,
	evaluation_period int,
	indicators_evaluation bit,
	indicators_performmance bit,
	indicators_satisfaction bit
)
go
...
create table assistance_approval
(
	id int identity
		primary key,
	approval bit default 0 not null,
	assistance int,
	period varchar(50)
)
go
...
create unique index assistance_id_uindex
	on assistance_approval (id)
go

declare @sn nvarchar(30)
set @sn = schema_name()
execute sp_addextendedproperty N'MS_Description', N'Assitance control', N'SCHEMA', @sn, N'TABLE', N'assistance_approval'
go
...
declare @sn nvarchar(30)
set @sn = schema_name()
execute sp_addextendedproperty N'MS_Description', N'Valie is the sstatus ', N'SCHEMA', @sn, N'TABLE', N'assistance'
go
