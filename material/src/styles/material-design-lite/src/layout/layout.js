...
(function () {
  ...
  */
  MaterialLayout.prototype.toggleDrawer = function () {
    const drawerButton = this.element_.querySelector(`.${this.CssClasses_.DRAWER_BTN}`);
    ...
    if (this.element_) {
      ...
      if (this.drawer_) {
        ...
        if (!drawerButton) {
          ...
          const drawerButtonIcon = document.createElement('i');
      ...
      if (this.header_ && this.tabBar_) {
        ...
        const windowResizeHandler = function () {
          ...
          }, /** @type {number} */ (this.Constant_.RESIZE_TIMEOUT));
        }.bind(this);
        ...
        const panels = this.content_.querySelectorAll(`.${this.CssClasses_.PANEL}`);
