...
(function () {
   ...
   */
  const MaterialRadio = function MaterialRadio(element) {
  ...
  MaterialRadio.prototype.onChange_ = function (event) {
    ...
    const radios = document.getElementsByClassName(this.CssClasses_.JS_RADIO);
    for (let i = 0; i < radios.length; i++) {
      const button = radios[i].querySelector(`.${this.CssClasses_.RADIO_BTN}`);
