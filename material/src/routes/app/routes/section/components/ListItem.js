      ...
      <tr>
        ...
        <td className="mdl-data-table__cell--non-numeric" style={{textAlign: 'right'}}>
          {(this.props.sectionData.createdGroup) ?
            (this.props.sectionData.groupExists) ?
              <button
                onClick={() => {
                  this.props.onViewGroup(this.props.sectionData.id);
                }}
                type="submit"
              ...
              <button
                onClick={() => {
                  this.props.onCreateGroup(this.props.sectionData.id);
                }}
                type="submit"
          ...
          <button
            onClick={() => {
              this.props.onEdit(this.props.sectionData)
            }}
          ...
          <button
            onClick={() => {
              this.props.onDelete(this.props.sectionData.id)
            }}
