  ...
  render () {
    return (
      <tr>
        ...
        <td className="mdl-data-table__cell--non-numeric">{this.props.courseData.nameProgram}</td>
        ...
        <td className="mdl-data-table__cell--non-numeric" style={{textAlign:'right'}}>
          {(this.props.courseData.createdGroup) ?
            (this.props.courseData.groupExists) ?
              <button
                onClick={() => {
                  this.props.onViewGroup(this.props.courseData.id);
                }}
                type="submit"
              ...
              <button
                onClick={() => {
                  this.props.onCreateGroup(this.props.courseData.id);
                }}
                type="submit"
