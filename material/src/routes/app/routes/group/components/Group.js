    ...
    return (
      <article className="article padding-lg-v article-dark article-bordered">
        ...
        <div className="with-maxwidth">
          <div className="row">
            {this.props.permission.pstudentInscription && <div className="col-xl-4">
            ...
            {this.props.permission.pstudentApproval && <div className="col-xl-4">
              <a
                onClick={() => {
                this
                  .context
          ...
          <div className="row">
            {this.props.permission.pnotesEntry && <div className="col-xl-4">
              <a href="#/app/user">
                <div className="box box-default">
                  <div className="box-body">
                    <div className="icon-box ibox-plain ibox-center">
          ...
          <div className="row">
            {this.props.permission.pmonitoringEntry && <div className="col-xl-4">
              <a href="#/app/user">
                <div className="box box-default">
                  <div className="box-body">
                    <div className="icon-box ibox-plain ibox-center">
            ...
            {this.props.permission.pevaluationEntry && <div className="col-xl-4">
              <a href="#/app/page/catalog">
                <div className="box box-default">
                  <div className="box-body">
                    <div className="icon-box ibox-plain ibox-center">
